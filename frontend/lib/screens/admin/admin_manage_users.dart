...
class _AdminManageUsersState extends State<AdminManageUsers> {
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () async {
              ...
              if (success) {
                _showSnackBar('Akun $userName berhasil dihapus.', Colors.green);
                await _loadAllData();
              } else {
                setState(() => isLoading = false);
                _showSnackBar('Gagal menghapus akun.', Colors.red);
              }
            },
                            ...
                            : data.isEmpty
                                ? ListView(
                                    ...
                                    children: [
                                      ...
                                      Icon(icon, color: Colors.grey.shade300, size: 70),
              ...
              : RefreshIndicator(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        // Teks kembali dihitamkan agar terlihat di BG terang
                        const Text(
                          'Users',
                          style: TextStyle(
                            fontSize: 26,
  ...
  Widget _buildUserCard(Map<String, dynamic> user) {
    ...
    final List<dynamic> badges = user['unlocked_achievements'] is List ? user['unlocked_achievements'] : [];
            ...
            children: [
              CircleAvatar(
                ...
                child: user['avatar_url'] == null || user['avatar_url'] == ''
                    ? Text(
                        (user['nama_lengkap'] ?? 'U').toString().trim().characters.first.toUpperCase(),
              ...
              Column(
                ...
                children: [
                  Container(
                    ...
                    child: Text('Level $level', style: const TextStyle(color: Colors.deepPurple, fontWeight: FontWeight.bold, fontSize: 11)),
                  ),
                  if (isAdmin) ...[
              ...
              if (!isAdmin)
                IconButton(
                  onPressed: () => _confirmDeleteUser(_getUserId(user), user['nama_lengkap'] ?? 'User'),
            ...
            children: [
              ...
              InkWell(
                ...
                child: Row(
                  children: [
                    if (badges.isEmpty)
                      const Icon(Icons.emoji_events_outlined, color: Colors.grey, size: 16)
                    else
                      ...badges.take(3).map((_) => const Padding(
  ...
  Widget _buildClickableSmallStat({required IconData icon, required String label, required Color color, required VoidCallback? onTap}) {
    final child = Row(
      children: [
    ...
    return InkWell(
      ...
      child: Padding(padding: const EdgeInsets.symmetric(horizontal: 3, vertical: 4), child: child),
    );
  }
