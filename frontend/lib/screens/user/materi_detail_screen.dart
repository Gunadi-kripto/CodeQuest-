...
class _MateriDetailScreenState extends State<MateriDetailScreen> {
  ...
  void initState() {
    super.initState();
    _loadUserAndMarkAsRead();
  }

  Future<void> _loadUserAndMarkAsRead() async {
    ...
    if (userId.isEmpty || moduleId.isEmpty) return;
              ...
              children: [
                ...
                Expanded(
                  child: ElevatedButton(
                    onPressed: isCompletingModule
                        ? null
                        : _completeModuleAndOpenQuiz,
